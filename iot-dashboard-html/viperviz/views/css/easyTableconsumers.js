...
$.fn.easyTable = function (options) {
   ...
   this.buttons = function () {
	...
	var menu = '<div id=\'easyMenuTable\' class=\'row\'>' + clear + '<div class=\'col-md-3 pull-left\'></div> <div class=\'col-md-6 pull-right\'></div></div>';
   ...
   this.filter = function () {
      ...
      if (trIndex === 'all') {
         $("#search").attr('placeholder', $("#search").attr('placeholder') + ' Consumers');
      } else {
      }
